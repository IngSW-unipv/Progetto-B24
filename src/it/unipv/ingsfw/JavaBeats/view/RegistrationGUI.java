...
public class RegistrationGUI{
  ...
  private static final int vboxWidth=700;
  ...
  private void initComponents(){
    ...
    /* SetUp of the background Pone that "holds" the VBox in the middle of the screen */
    AnchorPane ap=new AnchorPane(v);
    AnchorPane.setLeftAnchor(v, (double)((clientWidth/2)-(vboxWidth/2)));
    AnchorPane.setTopAnchor(v, (double)((clientHeight/2)-(vboxHeight/2)));
    ap.setBackground(new Background(new BackgroundFill(Color.rgb(15, 15, 15), CornerRadii.EMPTY, Insets.EMPTY)));
    scene=new Scene(ap, 1920, 1080);
  }
  /*---------------------------------------*/
}