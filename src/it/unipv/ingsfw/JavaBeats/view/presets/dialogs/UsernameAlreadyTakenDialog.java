...
public class UsernameAlreadyTakenDialog extends Dialog<JBCollection> {
    /*---------------------------------------*/
    //Attributi
    /*---------------------------------------*/
    ...
    //Costruttori
    /*---------------------------------------*/
    public UsernameAlreadyTakenDialog(Stage stage, UsernameAlreadyTakenException exception, JBProfile jbProfile) {
        super();

        initOwner(stage);
        initStyle(StageStyle.UNDECORATED);
        initComponents(exception, jbProfile);
    }
    ...
    //Metodi
    /*---------------------------------------*/
    private void initComponents(UsernameAlreadyTakenException exception, JBProfile jbProfile) {
