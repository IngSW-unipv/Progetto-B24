...
public class SongbarHandler{
  ...
  public static SongbarHandler getInstance(JBProfile activeProfile, JBAudio currentAudio){
    if(instance==null || activeProfile==null || currentAudio==null){
  ...
  private void initHandlers(){
    ...
    InvalidationListener mediaPlayerDurationListener=new InvalidationListener(){
      ...
      public void invalidated(Observable observable){
        ...
        Songbar.getInstance().getMinutePassedLabel().setText(JBAudio.convertToHoursMinutesAndSeconds(((ReadOnlyObjectProperty<Duration>)observable).getValue().toMillis()));
      }
    };
